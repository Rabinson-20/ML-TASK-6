...
The project performs Exploratory Data Analysis (EDA) to understand patterns in the dataset.
...
Before applying Machine Learning algorithms, the dataset is prepared through preprocessing steps such as:
...
* Feature transformation/scaling when required
...
Predicting the academic performance of students based on available academic and engagement-related features.

### 2. Dropout Risk Prediction

Identifying students who may have a higher probability of dropping out.

### 3. Final Result Prediction

Predicting the student's final outcome such as:

`Pass | Fail | Withdrawn | Distinction`

### 4. Student Risk Analysis

Analyzing student engagement and academic characteristics to categorize students according to their risk level.

---

## 📈 Model Evaluation

The Machine Learning model can be evaluated using appropriate performance metrics such as:
...
**Colab Notebook:**
https://colab.research.google.com/drive/16OjUnk5fWE28r3eQyuXoeSM2UF5Rb1Bf

> Make sure the notebook's sharing permission is set to **Anyone with the link – Viewer** if you want other people to access it.
...
Some important areas investigated in this project include:
...
For example, if a student shows **low engagement, low academic performance, and high risk**, an educational institution could provide additional mentoring or support before the student withdraws.
